...
public class Main {
    ...
    static void suaGV() {
        ...
        for (GiaoVien x : arrListGiaoVien) {
            if (input.equalsIgnoreCase(x.getMaGV())) {
                System.out.println("Mời bạn sửa năm sinh của " + x.getMaGV());
                input = sc.nextLine();
                x.setNamsinh(Integer.parseInt(input));
                System.out.println("Mời bạn sửa sđt của " + x.getMaGV());
                input = sc.nextLine();
                x.setSdt(input);
                break;
            }
    ...
    static void xoaGV() {
        ...
        for (int i = 0; i < arrListGiaoVien.size(); i++) {
            if (input.equalsIgnoreCase(arrListGiaoVien.get(i).getMaGV())) {
                arrListGiaoVien.remove(i);//Xóa phần tử trong mảng dùng index
                break;
            }
        }
    ...
    static void timkiemGV() {
        ...
        for (int i = 0; i < arrListGiaoVien.size(); i++) {
            if (input.equalsIgnoreCase(arrListGiaoVien.get(i).getMaGV())) {
                System.out.println(arrListGiaoVien.get(i).toString());
                break;
            }
        }
    }
