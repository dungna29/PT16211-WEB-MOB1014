 ...
 * @author LegendNguyen
 */
public class S5_Wrapper {

    public static void main(String[] args) {
        //Kiểu dữ liệu nguyên thủy:int byte short long float double char boolean
        //Đặc điểm của lớp(Class) lúc nào cũng viết hoa chữ cái đầu của từ lên
        ...
        //với kiểu sô  nguyên int thì lớp bao của nó là Integer
